...
|---|---|---|
| **Member A** (Auth & Registration) | `auth.spec.js`, `profile.spec.js`, `route-protection.spec.js` | 25 |
| **Member B** (Orders & Payments) | `cart.spec.js`, `checkout.spec.js`, `user-orders.spec.js` | 18 |
| **Member C** (Products) | `home.spec.js`, `product-details.spec.js`, `admin-products.spec.js`, `search.spec.js` | 28 |
| **Member D** (Categories) | `categories.spec.js`, `admin-categories.spec.js`, `admin-orders.spec.js`, `navigation.spec.js` | 26 |

Cross-feature flows (Section 15) should be split among members based on the primary feature tested.
