...
// [Load Test] Concurrent Read-Write Mixed Workload
//
// Tests mixed read/write traffic at 50 VUs:
//   1. 80% reads / 20% writes (realistic e-commerce split)
//   2. Product photo requests (binary I/O)
//   3. Paginated page cycling (pages 1-3 consistency)
...
export const options = {
  ...
  thresholds: {
    ...
    page1_duration: ["p(95)<500"],
    page2_duration: ["p(95)<500"],
    page3_duration: ["p(95)<500"],
  },
};
...
export function handleSummary(data) {
  return {
    "results/load-mixed-workload-report.html": htmlReport(data),
    "results/load-mixed-workload-results.json": JSON.stringify(data, null, 2),
