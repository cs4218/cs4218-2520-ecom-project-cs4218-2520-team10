...
// [Load Test] Search & Filter API Under Expected Traffic
//
// Tests search/filter endpoints at 50 VUs steady state:
//   1. GET /api/v1/product/search/:keyword          (regex search)
//   2. POST /api/v1/product/product-filters          (filter by price)
//   3. GET /api/v1/product/product-category/:slug    (category listing)
//   4. GET /api/v1/product/related-product/:pid/:cid (related products)
...
export const options = {
  ...
  thresholds: {
    ...
    category_products_duration: ["p(95)<500"],
    related_products_duration: ["p(95)<500"],
  },
};
...
export function handleSummary(data) {
  return {
    "results/load-search-filter-report.html": htmlReport(data),
    "results/load-search-filter-results.json": JSON.stringify(data, null, 2),
