...
// [Load Test] Product Browsing API Under Expected Traffic
//
// Tests GET product endpoints at 50 VUs steady state:
//   1. GET /api/v1/product/get-product         (all products)
//   2. GET /api/v1/product/product-list/:page   (paginated)
//   3. GET /api/v1/product/get-product/:slug    (single detail)
//   4. GET /api/v1/product/product-count        (count)
...
export const options = {
  ...
  thresholds: {
    ...
    get_all_products_duration: ["p(95)<500"],
    paginated_list_duration: ["p(95)<500"],
    product_detail_duration: ["p(95)<500"],
    product_count_duration: ["p(95)<300"],
  },
};
...
export function handleSummary(data) {
  return {
    "results/load-product-browsing-report.html": htmlReport(data),
    "results/load-product-browsing-results.json": JSON.stringify(data, null, 2),
